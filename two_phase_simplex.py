...
class TwoPhaseSimplex:
    ...
    def __check_validity_of_arguments(
        self, a: Sequence[Sequence[float]], b: Sequence[float], c: Sequence[float]
    ) -> tuple[bool, str]:
        """
    ...
    def __get_solution(self, basis: np.ndarray):
        ...
        for i, var in enumerate(basis):
            ...
            solutions[var - 1] = self.__tableau[i + 1, 0]
        return solutions
    ...
    def __complete_phase_two(self, basis: np.ndarray) -> np.ndarray:
        """
    ...
    def solve_program(self) -> bool:
        ...
        basis = self.__complete_phase_two(basis)
